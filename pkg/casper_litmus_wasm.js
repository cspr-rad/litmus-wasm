...
* @returns {string}
*/
export function block_hash(json_block_js_value) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.block_hash(retptr, addHeapObject(json_block_js_value));
...
* @returns {any}
*/
export function process_query_proofs(merkle_proofs_hex_str, path) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(merkle_proofs_hex_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayJsValueToWasm0(path, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.process_query_proofs(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
const BlockValidatorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_blockvalidator_free(ptr >>> 0));
/**
*/
export class BlockValidator {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        BlockValidatorFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_blockvalidator_free(ptr);
    }
    /**
    * @param {bigint} era_number
    * @param {any} validator_weights_js_value
    */
    constructor(era_number, validator_weights_js_value) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertBigInt(era_number);
            wasm.blockvalidator_new(retptr, era_number, addHeapObject(validator_weights_js_value));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    * @param {any} json_block_js_value
    */
    validate(json_block_js_value) {
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertNum(this.__wbg_ptr);
            wasm.blockvalidator_validate(retptr, this.__wbg_ptr, addHeapObject(json_block_js_value));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('casper_litmus_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
